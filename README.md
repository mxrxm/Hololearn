#  HoloLearn – Holographic AI Learning Platform

## Overview
HoloLearn is an AI-powered interactive learning platform that transforms traditional education into immersive 3D experiences using AI, visualization, and intelligent tutoring systems.

---

##  Project Tasks Navigation

| Task | Description | Access |
|------|------------|--------|
| `Assignment01/` | User Research, User Persona | [Open](https://github.com/mxrxm/Hololearn/blob/main/HoloLearn_User_Research_Report.pdf) |
...
|`Behance`| Deployed project on behance |[Open](https://www.behance.net/gallery/248895983/HoloLearn-Mobile-App)|
| `Final Demo` | Mobile App Demo Video | [Open](https://github.com/mxrxm/Hololearn/blob/main/Mobile_app_demo_final.mp4) |
